...
const Footer = () => {
  return (
    ...
    style={{
     ...
     className="py-10 bg-black sm:pt-16 lg:pt-24 ">
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            ...
            <div className="flex-shrink-0">
              <a href="/" title="" className="flex">
                ...
                <p className="text-base leading-relaxed text-white mt-7">257/B, West Manikdi, Dhaka CantonmentDhaka - 1206</p>
        ...
        <p className="text-sm text-center text-white">© Copyright 2024, All Rights Reserved by dhakaautos</p>
    </div>
</section>
  );
};
