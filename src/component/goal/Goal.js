        ...
        <div style={{
          ...
          <div className="flex items-center justify-center text-center lg:text-left lg:col-span-4">
            <div className="px-4 py-12 lg:px-16 lg:py-20 xl:py-0 xl:px-40">
              <h2 className="max-w-xl px-4 mx-auto text-3xl font-bold text-white sm:px-0 lg:mx-0 sm:text-3xl lg:text-4xl xl:text-5xl">
              Benefits of Pre-Ordering
              </h2>
              <p className="max-w-md mt-4 text-lg font-semibold text-gray-300 sm:mx-auto lg:mx-0 sm:mt-8">
              Pre-order your next car today and be the first to drive it!
              </p>

              <ul className="mt-2 list-disc list-inside">
  <li className="text-white">Access to exclusive models and hard-to-find vehicles</li>
  <li className="text-white">Personalized service to match your preferences</li>
  <li className="text-white">Priority delivery once your vehicle arrives</li>
</ul>
